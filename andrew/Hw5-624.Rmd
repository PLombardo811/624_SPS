...
plot(forecast2)
```
Unlike our model which forecasts values staying level, the ETS model forecasts falling values. While the upper bounds of each condidence interval appear similar for each model, the ETS model has lower bounds within the confidence intervals.  
