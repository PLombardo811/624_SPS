...
```{r}
predict_var05 <- round(as.numeric(stlf_arima_fit$mean),2)
predict_var07 <- round(as.numeric(var07_stlf_arima$mean),2)
df_predict <- data.frame(predict_var05,predict_var07)
S03_df_NA <- S03_df[1623:1762,]
S03_df_NA$Var05 <- df_predict$predict_var05
S03_df_NA$Var07 <- df_predict$predict_var07
S03_df_NA
S03_df_train
S03_df_final <- rbind(S03_df_train, S03_df_NA)
write.csv(S03_df_final,"predict_S03.csv")
```
```{r}
...
S01_df_NA <- S01_df[1623:1762,]
S01_df_NA$Var01 <- df_predict$predict_var01
S01_df_NA$Var02 <- df_predict$predict_var02
S01_df_final <- rbind(S01_df_train, S01_df_NA)
write.csv(S01_df_final,"predict_S01.csv")
```
S02
```{r}
...
S02_df_NA <- S02_df[1623:1762,]
S02_df_NA$Var02 <- df_predict$predict_var02
S02_df_NA$Var03 <- df_predict$predict_var03
S02_df_final <- rbind(S02_df_train, S02_df_NA)
write.csv(S02_df_final,"predict_S02.csv")
```
S04
```{r}
...
predict_var02 <- round(as.numeric(var02_stlf_arima$mean),2)
df_predict <- data.frame(predict_var01,predict_var02)
S04_df_NA <- S04_df[1623:1762,]
S04_df_NA$Var01 <- df_predict$predict_var01
S04_df_NA$Var02 <- df_predict$predict_var02
S04_df_final <- rbind(S04_df_train, S04_df_NA)
write.csv(S04_df_final,"predict_S04.csv")
```
S05
```{r}
...
predict_var03 <- round(as.numeric(var03_stlf_arima$mean),2)
df_predict <- data.frame(predict_var02,predict_var03)
S05_df_NA <- S05_df[1623:1762,]
S05_df_NA$Var02 <- df_predict$predict_var02
S05_df_NA$Var03 <- df_predict$predict_var03
S05_df_final <- rbind(S05_df_train, S05_df_NA)
write.csv(S05_df_final,"predict_S05.csv")
```
...
predict_var07 <- round(as.numeric(var07_stlf_arima$mean),2)
df_predict <- data.frame(predict_var05,predict_var07)
S06_df_NA <- S06_df[1623:1762,]
S06_df_NA$Var05 <- df_predict$predict_var05
S06_df_NA$Var07 <- df_predict$predict_var07
S06_df_final <- rbind(S06_df_train, S06_df_NA)
write.csv(S06_df_final,"predict_S06.csv")
```